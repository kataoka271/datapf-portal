                    ...
                    {alert.actual_value !== null &&
                      alert.threshold !== null && (
                        <p className="text-xs text-gray-400 mt-1">
                          実測: {alert.actual_value.toFixed(2)} / 閾値:{" "}
              ...
              <div className="bg-white rounded-xl border border-gray-100 p-4 space-y-3 sticky top-4">
                ...
                <div className="space-y-2 text-xs">
                  {[
                    ...
                    {
                      label: "実測値",
                      value: alertDetail.actual_value?.toFixed(4) ?? "-",
                    },
                    {
                      label: "閾値",
                      value: alertDetail.threshold?.toFixed(4) ?? "-",
                    },
                    {
                      label: "発生日時",
                      value: new Date(alertDetail.triggered_at).toLocaleString(
                        "ja-JP",
                      ),
                    },
                    {
                      label: "解決日時",
                      value: alertDetail.resolved_at
                        ? new Date(alertDetail.resolved_at).toLocaleString(
                            "ja-JP",
                          )
                        : "-",
                    },
