...
def mock_catalogs(user_id: str) -> list[dict]:
    return [
        ...
        {
            "catalog_name": "road_infrastructure",
            "display_name": "道路インフラデータ",
            "description": "道路状態・信号情報・工事情報などのインフラデータ。自律走行研究向け。",
            "owner_user_id": "tanaka@co.jp",
            "my_role": "none",
            "my_request_status": None,
            "requires_approval": False,
            "status": "ACTIVE",
            "mou_version": "v1",
            "updated_at": (_NOW - timedelta(days=8)).isoformat(),
        },
        {
            "catalog_name": "weather_telemetry",
            "display_name": "気象テレメトリ",
            "description": "気温・降水量・風速・視界などの気象データ。車両センサーデータとの結合分析に使用。",
            "owner_user_id": "nakamura@co.jp",
            "my_role": "editor",
            "my_request_status": "APPROVED",
            "requires_approval": False,
            "status": "ACTIVE",
        ...
        {
            "catalog_name": "adas_events",
            "display_name": "ADAS イベントログ",
            "description": "自動ブレーキ・車線逸脱・衝突警告などの ADAS 作動イベント記録。要承認。",
            "owner_user_id": "kobayashi@co.jp",
            "my_role": "none",
            "my_request_status": None,
            "requires_approval": True,
            "status": "ACTIVE",
